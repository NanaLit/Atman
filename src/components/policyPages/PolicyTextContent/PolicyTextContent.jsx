		...
		<div className={styles.policyContent}>
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.subText}>
					...
					безопасности персональных данных, предпринимаемые ООО "Атман-АВТО"
					(далее – Оператор).
				</p>
				<p className={styles.subText}>
				...
				<h2 className={styles.title}>2. Область применения.</h2>
				<p className={styles.subText}>
					<span>2.1. </span>Кодекс должен применяться сотрудниками компании, как
				...
				<p className={styles.subText}>
					<span>2.2. </span>Положения Кодекса должны быть понятны и ясны для
				...
				<p className={styles.text}>
					<span>2.3. </span>Отдельные положения Кодекса и порядок их реализации
			...
			<div className={styles.contentBlock}>
				...
				<p className={styles.text}>
					<span>13.1. </span>Оператор и иные лица, получившие доступ к
