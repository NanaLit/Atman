						...
						<ul className={styles.advantagesList}>
							<li className={styles.advantagesListItem}>
								<div className={styles.advantagesPoint}>
									...
									<span>
										Каждая партия сырья проходит входной контроль, а процессы производства готовой продукции соответствуют требованиям международных стандартов: ISO 9001, ГОСТ Р 58139, IATF 16949.
									</span>
								</div>
							</li>
							<li className={styles.advantagesListItem}>
